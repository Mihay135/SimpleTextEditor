...
import changeManager.WordWrapChangeManager;

class WordWrapChangeManagerTest {

	@Test
	void testWordWrapManagerInitialToggleIsCorrect() {
		boolean initial = true;
		WordWrapChangeManager wrapManager = new WordWrapChangeManager(initial);
		
		assertTrue(wrapManager.getCurrentToggle());
	}
	
	
//	@Test
//	void testStringChangeManagerSaveStringMovesCurrentStringPointer() {
//		boolean initialToggle = false;
//		WordWrapChangeManager stringManager = new WordWrapChangeManager(initialToggle);
//		
//		boolean updatedToggle = initialString + "Updated";
